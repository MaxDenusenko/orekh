                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            <div class="production__filter_title">
                                <p><?=GetMessage("CT_BCSF_FILTER_TITLE")?></p>
                                    ...
                                    case "P"://DROPDOWN
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar) {
                                            ...
                                            $ITEMS[] = [
                                                "name"      => $ar['VALUE'],
                                                "value"     => $ar['CONTROL_ID'],
                                                "dataRole"  => 'label_'.$ar['CONTROL_ID'],
                                                "disabled"  => $ar["DISABLED"] ? true : false,
                                                "selected"  => $ar["CHECKED"] ? true : false,
                                            ];
                                        }
                                        $ALL_ITEM = [
                                            "name"  => GetMessage("CT_BCSF_FILTER_ALL"),
                                            "value" => "all_".$arCur["CONTROL_ID"],
                                        ];
                                        if (!count($dropdownActive)) {
                                            $dropdownActive = $ALL_ITEM;
                                        }
                                        $ITEMS[] = $ALL_ITEM;
                                        ?>

                                        <div class="col-lg-4 bx-filter-parameters-box" title="<?=$arItem['NAME']?>" data-role="bx_filter_block">
                                            <span class="bx-filter-container-modef"></span>
                                            <select>
                                                <option value="hide"><?=$arItem['NAME']?></option>
                                                <?php foreach ($ITEMS as $ITEM) :?>
                                                    <option
                                                        data-disabled="<?=$ITEM['disabled']?>"
                                                        data-role-help="<?=$ITEM['dataRole']?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 align-self-center">
                            <div class="production__filter_price">
                                ...
                                ?>
                                <a href="?sort=price&order=<?=$request->get("order") == 'asc' ? 'desc' : 'asc'?>">
                                    <span><?=GetMessage("CT_BCSF_COST_SORT_TEXT")?></span>
                                    <i class="nut-icon icons-arrow-down <?= $request->get("order") == 'desc' ? 'accent' : '' ?>"></i>
                                    <i class="nut-icon icons-right-top <?= $request->get("order") == 'asc' ? 'accent' : '' ?>"></i>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-7 ">
                            <div class="production__filter_button">
                                ...
                                <button
                                    ...
                                    <?=GetMessage("CT_BCSF_SET_FILTER")?> <span id="modef_num_sec"></span>
                                </button>
                                ...
                                ><i class="nut-icon icons-close-button"></i><span> Сбросить</span></button>
