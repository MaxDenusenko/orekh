...
$APPLICATION->SetPageProperty("body_class", "page inside");
$APPLICATION->SetPageProperty("breadcrumb_container_class", "overlay");
$APPLICATION->SetPageProperty("breadcrumb_container_style", "background-image: url(".CFile::GetPath(\COption::GetOptionString( "askaron.settings", "UF_CATALOG_DEFAULT_IMAGE")).")");
...
$dbPriceType = CCatalogGroup::GetList(
    array("SORT" => "ASC"),
    array("CODE" => $arParams['PRICE_CODE'])
);
$arPriceType = $dbPriceType->Fetch();


$request = Context::getCurrent()->getRequest();
if ($request->get("sort") == "price" && isset($arPriceType['ID'])) {
    $arParams["ELEMENT_SORT_FIELD"] = "catalog_PRICE_{$arPriceType['ID']}";
}
if ($request->get("order")) {
    $arParams["ELEMENT_SORT_ORDER"] = $request->get("order") == 'asc' ? 'asc' : 'desc';
}
?>
            ...
            <div class="col-md-5">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/catalog/sections/title.php"
                    )
                );?>
                <div class="wrapper">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/include/catalog/sections/text.php"
                        )
                    );?>
                </div>
            </div>
            <?php
             $SECT_IMAGES = \COption::GetOptionString( "askaron.settings", "UF_CATALOG_SECTIONS_IMAGES");
             if (is_array($SECT_IMAGES) && count($SECT_IMAGES)) :?>
                <div class="col-md-7">
                    <!-- Swiper -->
                    <div class="manufacturer-container swiper-container">
                        <div class="swiper-wrapper">

                            <?php foreach ($SECT_IMAGES as $SECT_IMAGE_ID) :?>
                                <div class="swiper-slide">
                                    <div class="manufacturer__item">
                                        <img src="<?= CFile::GetPath($SECT_IMAGE_ID);?>" alt="alt">
                                    </div>
                                </div>
                            <?php endforeach; ?>
