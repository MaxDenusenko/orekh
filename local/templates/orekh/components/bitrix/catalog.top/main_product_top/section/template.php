...
<section class="production" data-entity="<?=$containerName?>">
    <div class="container">
            ...
            <div class="col-12">
                ...
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/main_page/catalog_top/title.php"
                    )
                );?>
                ...
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/include/main_page/catalog_top/text.php"
                    )
                );?>
        ...
        if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
        {
            ...
            <div class="row justify-content-center" data-entity="items-row">
                ...
                <? foreach ($arResult['ITEMS'] as $item):?>
                    <div class="col-lg-4 col-md-6 col-12 product-item-small-card">
                        <div class="wrap">
        ...
        <div class="row">
            <div class="wrapper">
                <a href="<?=SITE_DIR?>catalog/" class="button button_transparent">Перейти в магазин</a>
            </div>
        </div>
