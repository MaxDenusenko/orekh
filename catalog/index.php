...
<section class="first-section <?$APPLICATION->ShowProperty("breadcrumb_container_class")?>"
         style="<?$APPLICATION->ShowProperty("breadcrumb_container_style")?>">
	<div class="container">
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_MAIN_BLOCK_PROPERTY_CODE" => array(
			...
			3 => "ATT_ENERGY_VALUE",
			4 => "ATT_EXPIRATION",
			5 => "ATT_STORAGE_CONDITION",
		),
		"DETAIL_META_DESCRIPTION" => "-",
		"DETAIL_META_KEYWORDS" => "-",
		"DETAIL_PRODUCT_INFO_BLOCK_ORDER" => "sku,props",
		"DETAIL_PRODUCT_PAY_BLOCK_ORDER" => "rating,quantityLimit,quantity,priceRanges,buttons,price",
		...
		"LIST_META_KEYWORDS" => "-",
		"LIST_PRODUCT_BLOCKS_ORDER" => "sku,quantityLimit,quantity,props,price,buttons",
